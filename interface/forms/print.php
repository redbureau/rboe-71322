...
if (($data["duration"] != " ") || ($data["duration2"] != " ") || ($data["durtext"] != "")){
 print "<div class='span8'>";
 	print "<span class=text>Duration: " . $data["duration"] . " " .  $data["duration2"] . " " . $data["durtext"] . "</span>";
 print "</div>";
}
...
if (($data["severity"] != " ") || ($data["sevtext"] != "") || ($data["sizetext"] != "") || ($data["sizetext2"] != "") || ($data["sizetext3"] != "")){
 print "<div class='span8'>";
...
if (($data["sizetext"] != "") || ($data["sizetext2"] != "") || ($data["sizetext3"] != "")){
 print "<div class='span8'>";
print "<span class=text>Size: ". $data["sizetext"] . " cm" .  $data["sizetext2"] . " cm" .  $data["sizetext3"] . " cm</span>";
 print "</div>";
}
...
if (($data["vascaaa"] != null) || ($data["vascradL"] != null) || ($data["vascradR"] != null) || ($data["vascfemL"] != null) || ($data["vascfemR"] != null) || ($data["vascpopL"] != null) || ($data["vascpopR"] != null) || ($data["vascdpL"] != null) || ($data["vascdpR"] != null) || ($data["vascptL"] != null) || ($data["vascptR"] != null)){
 ...
 print "<span class=text>" . $data["vascradL"] . " " . $data["vascradR"] . "</span><br>";
}

 if (($data["vascfemL"] != null) || ($data["vascfemR"] != null)) { 
 print "<span class=text>" . $data["vascfemL"] . " " . $data["vascfemR"] . "</span><br>";
}

 if (($data["vascpopL"] != null)|| ($data["vascpopR"] != null)) { 
 print "<span class=text>" . $data["vascpopL"] . " " . $data["vascpopR"] . "</span><br>";
}

 if (($data["vascdpL"] != null) || ($data["vascdpR"] != null)) { 
 print "<span class=text>" . $data["vascdpL"] . " " . $data["vascdpR"] . "</span><br>";
}
 
 if (($data["vascptL"] != null) || ($data["vascptR"] != null)) {
 print "<span class=text>" . $data["vascptL"] . " " . $data["vascptR"] . "</span><br>";
}
}
