<div class="control-group">
   ...
   <div class="control-group">
        ...
        <div class="controls">
             ...
             LUQ</label>
             <label class="checkbox inline"><input type="hidden" name="abdtender4" value=""><input type="checkbox" name="abdtender4" value="LLQ." <?php if ($record["abdtender4"] == 'LLQ.') echo "checked";?>>
             LLQ</label>
             <label class="checkbox inline"><input type="hidden" name="abdtender5" value=""><input type="checkbox" name="abdtender5" value="Suprapubic." <?php if ($record["abdtender5"] == 'Suprapubic.') echo "checked";?>>
             Suprapubic</label>
             <label class="checkbox inline"><input type="hidden" name="abdtender6" value=""><input type="checkbox" name="abdtender6" value="Costovertebral angle." <?php if ($record["abdtender6"] == 'Costovertebral angle.') echo "checked";?>>
             Costovertebral angle</label>
             <label class="checkbox inline"><input type="hidden" name="abdtender7" value=""><input type="checkbox" name="abdtender7" value="Epigastric." <?php if ($record["abdtender5"] == 'Suprapubic.') echo "checked";?>>
             Epigastric</label>
             <label class="checkbox inline"><input type="hidden" name="abdtender8" value=""><input type="checkbox" name="abdtender8" value="Umbilical." <?php if ($record["abdtender5"] == 'Suprapubic.') echo "checked";?>>
             Umbilical</label><br>
             ...
             Umbilical</label>
             <label class="checkbox inline"><input type="hidden" name="abdhernia4" value=""><input type="checkbox" name="abdhernia4" value="Ventral." <?php if ($record["abdhernia4"] == 'Ventral.') echo "checked";?>>
             Ventral</label>
             <label class="checkbox inline"><input type="hidden" name="abdhernia5" value=""><input type="checkbox" name="abdhernia5" value="Incisional." <?php if ($record["abdhernia5"] == 'Incisional.') echo "checked";?>>
             Incisional</label>
             <label class="checkbox inline"><input type="hidden" name="abdhernia6" value=""><input type="checkbox" name="abdhernia6" value="Spigellian." <?php if ($record["abdhernia6"] == 'Spigellian.') echo "checked";?>>
             Spigellian</label><br>
