...
<script language="javascript">
	...
	$(document).ready(function() {
		...
		$('.rbreastdimptag input').change(function(){updatebreastdimp();});
		$('.rbreasttendertag input').change(function(){updatebreasttender();});
		$('.rbreastdischargetag input').change(function(){updatebreastdischarge();});
    });
	...
	function updatebreastdimp() {
		...
		if ($('#rbreastdimp1').is(':checked') || $('#rbreastdimp2').is(':checked') || $('#rbreastdimp3').is(':checked') || $('#rbreastdimp4').is(':checked') || $('#rbreastdimp5').is(':checked')) { 
			$('#rbreastdimp').removeAttr('checked');
		}
	}
	function updatebreasttender() {
		...
		if ($('#rbreasttender1').is(':checked') || $('#rbreasttender2').is(':checked') || $('#rbreasttender3').is(':checked') || $('#rbreasttender4').is(':checked') || $('#rbreasttender5').is(':checked')) { 
			$('#rbreasttender').removeAttr('checked');
		}
	}
	function updatebreastdischarge() {
		...
		if ($('#rbreastdischarge1').is(':checked') || $('#rbreastdischarge2').is(':checked') || $('#rbreastdischarge3').is(':checked')) { 
			$('#rbreastdischarge').removeAttr('checked');
		}
